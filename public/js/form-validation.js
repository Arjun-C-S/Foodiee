(function ($) {
  ...
  $(function () {
    ...
    $("#addCategoryOffer").validate({
      ...
      messages: {
        Category_name: "Please select a category name",
        Category_Offer: {
          required: "Please enter category offer",
          max: "Offer cannot be greater than 90%",
          min: "Offer cannot be less than 1%",
        },
      },
      errorPlacement: function (label, element) {
        label.addClass("mt-2 text-danger");
    ...
    $("#addCoupon").validate({
      ...
      messages: {
        Product_name: "Please add a coupon name",
        Product_Offer: {
    ...
    $("#editCoupon").validate({
      ...
      messages: {
        Coupon_name: "Please add a coupon name",
        Offer_Percentage: {
          required: "Please enter coupon offer",
          max: "Offer cannot be greater than 90%",
          min: "Offer cannot be less than 1%",
